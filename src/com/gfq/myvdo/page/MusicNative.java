...
public class MusicNative extends BasePage implements OnItemClickListener{
	...
	private Handler handler=new Handler() {
		public void handleMessage(android.os.Message msg) {
			if(hasLength(items)) {
				adapter=new MyVideoNativeAdapter(items,mContext,false);
				listView.setAdapter(adapter);
				tv_not_found.setVisibility(View.GONE);
			}else {
				tv_not_found.setText("没有发现歌曲");
				tv_not_found.setVisibility(View.VISIBLE);
			}
			progressBar.setVisibility(View.GONE);
		};
	};
	public MusicNative(Context mContext) {
		super(mContext);
	}
	...
	public View initView() {
		...
		tv_not_found=(TextView) view.findViewById(R.id.tv_not_found);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		Intent intent=new Intent(mContext,MyMusicPlayer.class);
